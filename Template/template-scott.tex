...
\pgfdeclareimage[height=\paperheight]{scottbg}{figs/symregvsworld.jpg}
...
\setbeamertemplate{section page}{
    \begin{picture}(0,0)
        ...
        \put(175, -136){
            \colorbox{scottred}{
            \begin{minipage}[b][100mm][c]{55mm}
                \usebeamerfont{title}{\centering{\textcolor{white}{\insertsectionhead}}\par}
            \end{minipage}
        }
        }
...
\define@key{footline}{plain}[true]{
}
